"""Bronze job: landing/municipios → s3://bronze/municipios/ (Delta Lake).
...
def main():
    args = parse_args()
    input_path = args.input_path or f"s3a://landing/municipios/{args.snapshot_date}/"
    output_path = args.output_path or "s3a://bronze/municipios/"
