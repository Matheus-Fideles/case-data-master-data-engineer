"""Bronze job: landing/cnes → s3://bronze/cnes/ (Delta Lake).
...
def main():
    args = parse_args()
    input_path = args.input_path or f"s3a://landing/cnes/{args.snapshot_date}/"
    output_path = args.output_path or "s3a://bronze/cnes/"
