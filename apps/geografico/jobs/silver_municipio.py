"""Silver job: bronze/geografico/municipios → s3://silver/geografico/municipio/ (Delta Lake).
...
def main():
    ...
    MunicipioSilverJob().run(
        spark=spark,
        input_path="s3a://bronze/geografico/municipios/",
        output_path="s3a://silver/geografico/municipio/",
