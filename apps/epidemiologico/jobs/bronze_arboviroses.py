"""Bronze job: landing/epidemiologico/<agravo> → s3://bronze/epidemiologico/<agravo>/ (Delta Lake).
...
def main():
    args = parse_args()
    ano = args.ano_mes[:4]
    input_path = args.input_path or f"s3a://landing/epidemiologico/{args.agravo}/{ano}/"
    output_path = args.output_path or f"s3a://bronze/epidemiologico/{args.agravo}/"
