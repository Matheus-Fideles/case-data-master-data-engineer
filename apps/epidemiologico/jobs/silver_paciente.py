"""Silver job: bronze/oltp/paciente → s3://silver/epidemiologico/paciente/ (Delta Lake).
...
from apps.shared.masking import mask_paciente, validate_no_pii
...
def main():
    args = parse_args()
    input_path = args.input_path or "s3a://bronze/oltp/paciente/"
    output_path = args.output_path or "s3a://silver/epidemiologico/paciente/"
