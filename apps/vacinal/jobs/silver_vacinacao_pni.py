"""Silver job: bronze/vacinal/vacinacao_pni → s3://silver/vacinal/vacinacao_pni/ (Delta Lake).
...
def main():
    ...
    VacinacaoPniSilverJob().run(
        spark=spark,
        input_path="s3a://bronze/vacinal/vacinacao_pni/",
        output_path="s3a://silver/vacinal/vacinacao_pni/",
        filter_col="ano_mes",
