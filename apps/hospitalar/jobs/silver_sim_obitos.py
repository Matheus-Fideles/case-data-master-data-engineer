"""Silver job: bronze/hospitalar/sim_obitos → s3://silver/hospitalar/sim_obitos/ (Delta Lake).
...
def main():
    ...
    SimObitosSilverJob(salt=salt).run(
        spark=spark,
        input_path="s3a://bronze/hospitalar/sim_obitos/",
        output_path="s3a://silver/hospitalar/sim_obitos/",
        filter_col="ano_part",
        filter_val=args.ano,
