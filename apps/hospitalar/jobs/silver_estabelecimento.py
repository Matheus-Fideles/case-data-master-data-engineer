"""Silver job: bronze/hospitalar/cnes → s3://silver/hospitalar/estabelecimento/ (Delta Lake).
...
def main():
    ...
    EstabelecimentoSilverJob().run(
        spark=spark,
        input_path="s3a://bronze/hospitalar/cnes/",
        output_path="s3a://silver/hospitalar/estabelecimento/",
