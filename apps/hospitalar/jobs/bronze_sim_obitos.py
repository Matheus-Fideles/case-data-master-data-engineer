"""Bronze job: landing/hospitalar/sim_obitos → s3://bronze/hospitalar/sim_obitos/ (Delta Lake).
...
def main():
    args = parse_args()
    input_path = args.input_path or f"s3a://landing/hospitalar/sim_obitos/{args.ano}/"
    output_path = args.output_path or "s3a://bronze/hospitalar/sim_obitos/"
